...
export function HomeUnder10Section() {
  const { lots, isLoading } = useFeed("under_10k", 12);
  ...
  if (isLoading) {
    return (
      <section className="page-wrap">
        <h2 className="text-2xl font-bold mb-4">Under $10 000</h2>
  ...
  return <VehicleSlider title="Under $10 000" viewAllHref="/search?maxPrice=10000" cards={cards} />;
}
